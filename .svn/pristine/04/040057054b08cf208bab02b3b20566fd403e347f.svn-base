                ...
                <form action="{{route('register')}}" method="POST" class="margin-bottom-0">
                  ...
                  <input type="hidden" name="role" value="client">
                    <div class="form-group m-b-20">
                        ...
                        <input type="text" name="name" class="form-control input-lg" value="{{old('name')}}" placeholder="Email Address" />
                    </div>
                    <div class="form-group m-b-20">
											<label for="name">邮箱：</label>
                        <input type="text" name="email" class="form-control input-lg" value="{{old('email')}}" placeholder="email" />
                    </div>
										<div class="form-group m-b-20">
											<label for="name">密码：</label>
                        <input type="password" name="password" class="form-control input-lg" value="{{old('password')}}" />
                    </div>
										<div class="form-group m-b-20">
											<label for="name">确认密码：</label>
                        <input type="password" name="password_confirmation" class="form-control input-lg" value="{{ old('password_confirmation') }}" />
                    </div>
